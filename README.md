# 一种基于二合一脚本的ChatGPT大兵认证半自动化方法

### 1、部署两个脚本

由up我是李小黑黑黑提供，我进行改进，修复了因为各种因素表格元素加载不全导致的无限循环填表问题，在新版本中循环填表十次后会刷新网页
...
这个脚本的作用是报Verification Limit Exceeded错时，自动返回上级页面，并点击验证资格条件。
...
### 2、打开无痕浏览窗口并打开邮箱和验证页面

领取优惠网址：https://chatgpt.com/veterans-claim

### 3、打开信息网址并导入数据

信息网址：https://gravelocator.cem.va.gov/ngl/#iframe-content

### 4、启动脚本开始循环

出这种错误证明别的地方都没问题，只是你的信息不对，继续尝试就可以，纯运气

我就不一个个尝试了，慢慢来，三五百个也不是不可能的，
